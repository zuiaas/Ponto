    ...
    modalBox.innerHTML = `
        ...
        <div class="w-full">
            ...
            <div class="tab-content space-y-2" id="rank-content">
                <div class="bg-gradient-to-r from-yellow-500/20 to-yellow-500/5 p-3 rounded-lg flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <span class="text-slate-200">1</span>

                        <div class="w-8 h-8 rounded-full flex items-center justify-center overflow-hidden">
                            <img src="https://i.ibb.co/rGt5CcH1/default.png" />
                        </div>

                        <span class="text-slate-200">@mauricio_</span>
                    </div>

                    <span class="font-bold text-yellow-400">1250 pts</span>
                </div>

                <div class="bg-gradient-to-r from-gray-400/20 to-gray-400/5 p-3 rounded-lg flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-slate-200">@monster_cake</span>
                    </div>

                    <span class="font-bold text-slate-300">980 pts</span>
                </div>

                <div class="bg-gradient-to-r from-amber-600/20 to-amber-600/5 p-3 rounded-lg flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-slate-200">@presidenta_senac</span>
                    </div>

                    <span class="font-bold text-amber-600">875 pts</span>
                </div>

                <div class="border-white/25 border p-3 rounded-lg text-slate-200 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-slate-200">@____x_</span>
                    </div>

                    <span class="font-bold !text-slate-200">720 pts</span>
                </div>
                ...
                <div class="border-white/25 border p-3 rounded-lg text-slate-200 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-slate-200">@RafaelGerminari</span>
                    </div>

                    <span class="font-bold text-slate-200">695 pts</span>
                </div>
                ...
                <div class="bg-gradient-to-r from-cyan-500/20 to-cyan-500/5 border border-cyan-500/30 p-3 rounded-lg text-slate-200 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-slate-200">Você</span>
                    </div>
